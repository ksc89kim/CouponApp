...
//     Merchant
    ...
    init(couponId:Int,merchantId:Int, circleColor:String, ringColor:String, ringThickness:CGFloat,isRing:Bool,checkLineWidth:CGFloat,checkLineColor:String,isEvent:Bool) {
    ...
    convenience init(resultSet:FMResultSet) {
        ...
        self.init(couponId: Int(couponIdx), merchantId: Int(merchantIdx), circleColor: circleColor, ringColor: ringColor, ringThickness: ringThickness, isRing: isRing, checkLineWidth: checkLineWidth, checkLineColor: checkLineColor, isEvent: isEvent)
    }
