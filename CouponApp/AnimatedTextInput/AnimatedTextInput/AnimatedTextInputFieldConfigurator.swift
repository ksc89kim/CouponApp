...
fileprivate struct AnimatedTextInputPasswordConfigurator {
    ...
    static func generate(toggleable: Bool) -> TextInput {
        ...
        if toggleable {
            ...
            let normalImage = UIImage(named: "cm_icon_input_eye_normal", in: Bundle.main, compatibleWith: nil)
            let selectedImage = UIImage(named: "cm_icon_input_eye_selected", in: Bundle.main, compatibleWith: nil)
